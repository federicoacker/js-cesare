...
const messaggio = prompt("Inserisci il messaggio da cifrare:")
  .toLowerCase()
  .trim();
...
for (let i = 0; i < messaggio.length; i++) {
  ...
  if (indiceLettera !== -1) {
    // Se il char corrente non è uno spazio o un segno di punteggiatura o un razzo missile o qualsiasi altra cosa
    ...
    // Se è uno spazio o un segno di punteggiatura
